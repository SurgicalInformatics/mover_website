...
lasso_out_basic = read_rds("/home/common/mover_data/results/baseline_model/lasso_out_basic.rds")

```

We also fit a model based on the patient info+LDA:

```{r eval=F, echo=F, waring=F, output=F}
...
#lasso_out_all %>% 
#  write_rds("/home/common/mover_data/results/baseline_model/lasso_out_all.rds")
```

```{r echo=F, output=F, warning=F}
lasso_out_all = read_rds("/home/common/mover_data/results/baseline_model/lasso_out_all.rds")
```
